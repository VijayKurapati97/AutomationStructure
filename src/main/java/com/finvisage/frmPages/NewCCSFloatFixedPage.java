...
public class NewCCSFloatFixedPage extends BasePageFRM {
    ...
    private final By paymentFreqvalues=By.xpath("(//select[@id='payment_frequency_leg3']/following-sibling::div/div)[2]");
    ...
    public NewCCSFloatFixedPage selectUnderlying(String value){
    ...
    public NewCCSFloatFixedPage selectStructure(String value){
    ...
    public NewCCSFloatFixedPage selectValuationCcy(String value){
    ...
    public NewCCSFloatFixedPage clickMarketData(){
        clickk(marketData,WaitStrategy.CLICKABLE,"Market data");
        return this;
    }
    public NewCCSFloatFixedPage marketDataIsDisplayed(){
    ...
    public NewCCSFloatFixedPage clickNextButton(){
        clickk(btnNext,WaitStrategy.CLICKABLE,"Next Button");
        return this;
    }
    public NewCCSFloatFixedPage enterTenor(String tenorr){
        sendText(tenor,tenorr,WaitStrategy.PRESENCE,"Tenor");
        return this;
    }
    public NewCCSFloatFixedPage selectPaymentFrequency(String freq){
        Uninterruptibles.sleepUninterruptibly(3,TimeUnit.SECONDS);
        jsClick(paymentFreq,WaitStrategy.CLICKABLE,"Payment frequency dropdown");
        if(isDisplayed(paymentFreqvalues,WaitStrategy.VISIBLE,"payment freq menu")){
    ...
    public NewCCSFloatFixedPage clickPrice(){
        Uninterruptibles.sleepUninterruptibly(3,TimeUnit.SECONDS);
