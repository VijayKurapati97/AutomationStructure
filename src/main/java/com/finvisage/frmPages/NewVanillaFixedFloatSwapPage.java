...
public class NewVanillaFixedFloatSwapPage extends BasePageFRM {
    ...
    private final By price=By.xpath("//a[text()=' Price']");
...
private final By notional=By.xpath("//input[@id='pricing_object_pricing_data_notional']");
    ...
    public NewVanillaFixedFloatSwapPage selectUnderlying(String value){
    ...
    public NewVanillaFixedFloatSwapPage selectStructure(String value){
    ...
    public NewVanillaFixedFloatSwapPage clickMarketData(){
        clickk(marketData,WaitStrategy.CLICKABLE,"Market data");
        return this;
    }
    public NewVanillaFixedFloatSwapPage marketDataIsDisplayed(){
    ...
    public NewVanillaFixedFloatSwapPage clickNextButton(){
        clickk(btnNext,WaitStrategy.CLICKABLE,"Next Button");
        return this;
    }
    public NewVanillaFixedFloatSwapPage enterTenor(String tenorr){
        sendText(tenor,tenorr,WaitStrategy.PRESENCE,"Tenor");
        return this;
    }
    public NewVanillaFixedFloatSwapPage selectPaymentFrequency(String freq){
    ...
    public NewVanillaFixedFloatSwapPage clickPrice(){
