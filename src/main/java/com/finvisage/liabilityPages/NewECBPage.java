...
public class NewECBPage extends BasePageLiability{
    ...
    private final By ecbAmout =By.id("ecb_umbrella_amount");
    ...
    private final By personalGaurantee=By.xpath("//select[@id='ecb_cover_detail_attributes_personal_guarantee']/following-sibling::div/div[1]");
    private final By corporateGaurantee=By.xpath("//select[@id='ecb_cover_detail_attributes_corporate_guarantee']/following-sibling::div/div[1]");
    ...
    private final By personalGauranteeValue=By.id("ecb_cover_detail_attributes_personal_guarantee_value");
    private final By corporateGauranteeValue=By.id("ecb_cover_detail_attributes_corporate_guarantee_value");
    ...
    public NewECBPage enterFacilityAmount(String text){
        clickk(ecbAmout,WaitStrategy.CLICKABLE,"Facility Amount textbox");
        sendText(ecbAmout,text,WaitStrategy.PRESENCE,"Facility Amount");
        return this;
    }
