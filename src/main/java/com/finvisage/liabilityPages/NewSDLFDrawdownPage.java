...
public class NewSDLFDrawdownPage extends BasePageLiability{
    ...
    public NewSDLFDrawdownPage enterDrawdownExternalID(int count) {
    ...
    public NewSDLFDrawdownPage enterDrawdownEndDate(String text) {
    ...
    public NewSDLFDrawdownPage enterLoanAcnt(String value) {
    ...
    public NewSDLFDrawdownPage selectOperatingAcnt(String text) {
    ...
    public NewSDLFDrawdownPage clickNewDisbursement() {
        clickk(newDisbursement, WaitStrategy.CLICKABLE, "new Disbursement button");
        return this;
    }
    public NewSDLFDrawdownPage enterDisAmount(String value) {
    ...
    public NewSDLFDrawdownPage selectDisbursementType(String text) {
    ...
    public NewSDLFDrawdownPage clickNewIrSlab() {
        clickk(newInterestSlab, WaitStrategy.CLICKABLE, "new IR slab");
        return this;
    }

    public NewSDLFDrawdownPage selectIRType(String text) {
    ...
    public NewSDLFDrawdownPage enterSpread(String value) {
    ...
    public NewSDLFDrawdownPage selectPut_Call(String value) {
    ...
    public NewSDLFDrawdownPage clickNewTDS() {
        jsClick(newTDS, WaitStrategy.CLICKABLE, "New TDS");
        return this;
    }

    public NewSDLFDrawdownPage enterTDS(String tds) {
    ...
    public NewSDLFDrawdownPage enterAdditionalInfo(String text) {
        sendText(additionalInfo, text, WaitStrategy.PRESENCE, "Additional Info");
        return this;
    }

    public SDLFDrawdownPage clickCreate() {
