...
public class NewSubDebtSDDTranchePage extends BasePageLiability{
    ...
    public NewSubDebtSDDTranchePage enterExternalID(int count) {
    ...
    public NewSubDebtSDDTranchePage enterTrancheIssueLimit(String value) {
        doubleClick(trancheIssueLimit);
        actionSendkeys(value);
        return this;
    }

    public NewSubDebtSDDTranchePage enterOverSubscription(String value) {
        doubleClick(overSubscription);
        actionSendkeys(value);
        return this;
    }
    public NewSubDebtSDDTranchePage selectDaysInYeartype(String text) {
    ...
    public NewSubDebtSDDTranchePage selectRegistrar(String text) {
    ...
    public NewSubDebtSDDTranchePage selectTrustee(String text) {
    ...
    public NewSubDebtSDDTranchePage selectDepositories(String text) {
    ...
    public NewSubDebtSDDTranchePage selectLeadManager(String text) {
    ...
    public NewSubDebtSDDTranchePage selectOperatingAccount(String text) {
    ...
    public NewSubDebtSDDTranchePage selectSettlementBankAcnt(String text) {
    ...
    public NewSubDebtSDDTranchePage clickNewIrSlab() {
        clickk(newInterestSlab, WaitStrategy.CLICKABLE, "new IR slab");
        return this;
    }

    public NewSubDebtSDDTranchePage selectIRType(String text) {
    ...
    public NewSubDebtSDDTranchePage enterSpread(String value) {
