...
public class SDDTranchePage extends BasePageLiability {
    ...
    public SDDTranchePage clickClose() {
    ...
    public SDDTranchePage clickCreditRatingTab() {
        clickk(creditRatingTab, WaitStrategy.CLICKABLE, "Credit Rating Tab");
        return this;
    }

    public SDDTranchePage clickAddCreditRating() {
        clickk(btn_addCreditRating, WaitStrategy.CLICKABLE, "Add Credit Rating");
        return this;
    }

    public SDDTranchePage selectRatingAgency(String text) {
    ...
    public SDDTranchePage selectRatingSymbol(String text) {
    ...
    public SDDTranchePage selectOutlook(String text) {
    ...
    public SDDTranchePage clickFeetab() {
        clickk(feeTab, WaitStrategy.CLICKABLE, " Fee Tab");
        return this;
    }

    public SDDTranchePage clickAddFee() {
        jsClick(btn_AddFee, WaitStrategy.CLICKABLE, " Add Fee button");
        return this;
    }

    public SDDTranchePage feeType(String feeType) {
        Uninterruptibles.sleepUninterruptibly(3, TimeUnit.SECONDS);
    ...
    public SDDTranchePage amountType(String amountType) {
    ...
    public SDDTranchePage enterFeeValue(String feevalue) {
    ...
    public SDDTranchePage enterRemarks(String remarks) {
    ...
    public SDDTranchePage cancelFee() {
        try {
    ...
    public SDDTranchePage clickCovenantsTab() {
        clickk(covenantsTab, WaitStrategy.CLICKABLE, "Covenants Tab");
        return this;
    }

    public SDDTranchePage clickAddCovenants() {
        clickk(btn_addCovenants, WaitStrategy.CLICKABLE, "Add Covenants Button");
        Uninterruptibles.sleepUninterruptibly(3, TimeUnit.SECONDS);
        return this;
    }

    public SDDTranchePage covenantTemplate(String tem) {
    ...
    public SDDTranchePage enterAccountablePerson(String text) {
        sendText(accountablePerson, text, WaitStrategy.PRESENCE, "Accountable Person");
        return this;
    }

    public SDDTranchePage enterThirdParty(String text) {
        sendText(thirdParty, text, WaitStrategy.PRESENCE, "ThirdParty");
        return this;
    }

    public SDDTranchePage enterTargetValue(String text) {
    ...
    public SDDTranchePage selectMappingConditions(String text) {
    ...
    public SDDTranchePage selectCovenantsEntity(String text) {
    ...
    public SDDTranchePage selectRatioName(String text) {
    ...
    public SDDTranchePage enterThresholdPercentage(String text) {
    ...
    public SDDTranchePage enterCloseNotes(String value) {
    ...
    public ShelfTrancheStructurePage clickDeleteIcon() {
        for (int i = 0; i < 10; i++) {
            try {
    ...
    public SDDTranchePage enterRTAIntimationOffset(String value) {
    ...
    public SDDTranchePage enterPaymentAlertOffset(String value) {
    ...
    public SDDTranchePage create_SDD_Tranche_nonZeroCoupon() {
    ...
    public SDDTranchePage selectPrincipalPaymentDay(String day) {
    ...
    public SDDTranchePage selectPrincipalPaymentConvention(String value) {
    ...
    public SDDTranchePage selectPrincipalRounding(String mode) {
    ...
    public SDDTranchePage clickOnPreview() {
        scrollIntoView(btn_preview);
        jsClick(btn_preview, WaitStrategy.CLICKABLE, "Preview");
        return this;
    }

    public SDDTranchePage clickOnGenerateSchedule() {
    ...
    public SDDTranchePage checkUnallocatedPrincipal() {
