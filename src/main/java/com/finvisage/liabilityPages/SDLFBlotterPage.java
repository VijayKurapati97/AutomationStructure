...
public class SDLFBlotterPage extends BasePageLiability {
    ...
    public SDLFBlotterPage enterLiability_uploadPayments_name(String FileName) {
    ...
    public SDLFBlotterPage checkPaymentsUploadIsCompleted(String name){
        for (int i=0;i<6;i++){
    ...
    public SDLFBlotterPage searchLoan(String ID) {
