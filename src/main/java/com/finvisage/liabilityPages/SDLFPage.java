...
public class SDLFPage extends BasePageLiability{
    ...
    private final By btn_Delete = By.xpath("//a[@data-original-title='Delete Loan Facility']/i");
    private final By btn_Edit = By.xpath("//a[@data-original-title='Edit Loan Facility']/i");
    ...
    public SDLFPage clickOptions() {
        clickk(options, WaitStrategy.CLICKABLE, "Drawdown option");
        return this;
    }

    public NewSDLFDrawdownPage clickAddDrawdown() {
    ...
    public SDLFPage enterCloseNotes(String value) {
    ...
    public SDLFPage clickLienDetails() {
        clickk(lienDetails, WaitStrategy.CLICKABLE, "Lien Details Tab");
        return this;
    }

    public SDLFPage clickAddToLienFD() {
    ...
    public SDLFPage enterAccountablePerson(String text){
        sendText(accountablePerson,text,WaitStrategy.PRESENCE,"Accountable Person");
        return this;
    }
    public SDLFPage enterThirdParty(String text){
        sendText(thirdParty,text,WaitStrategy.PRESENCE,"ThirdParty");
        return this;
    }
    public SDLFPage enterTargetValue(String text){
    ...
    public SDLFPage selectMappingConditions(String text){
    ...
    public SDLFPage selectCovenantsEntity(String text){
    ...
    public SDLFPage selectRatioName(String text){
    ...
    public SDLFPage enterThresholdPercentage(String text){
    ...
    public SDLFPage create_new_SubDebt_LoanFacility() {
        LiabilityDashboardsPage ldp = new LiabilityDashboardsPage();
        ldp.clickLiability().clickSubDebtLF().moveToHamburgerMenu().clickAdd()
