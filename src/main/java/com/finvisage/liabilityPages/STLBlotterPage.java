...
public class STLBlotterPage extends BasePageLiability{
    ...
    private final By firstExtId = By.xpath("(//tbody)[2]/tr[1]/td[2]");

    public STLBlotterPage moveToHamburgerMenu() {
        moveToElement(DriverManager.getDriver().findElement(hamburgerMenu), "HamburgerMenu");
        return this;
    }

    public NewShortTermLoanPage clickAdd() {
        jsClick(btn_Add, WaitStrategy.CLICKABLE, "Add Button");
        return new NewShortTermLoanPage();
    }

    public STLBlotterPage clickClosedTab() {
        clickk(closedTab, WaitStrategy.CLICKABLE, "Closed tab");
        return this;
    }

    public STLBlotterPage clickArchivedTab() {
        clickk(archivedTab, WaitStrategy.CLICKABLE, "Archived tab");
        return this;
    }

    public STLBlotterPage searchExtId(String ID) {
