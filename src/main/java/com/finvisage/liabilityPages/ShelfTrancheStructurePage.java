...
public class ShelfTrancheStructurePage extends BasePageLiability {
    ...
    public ShelfTrancheStructurePage clickOptions() {
    ...
    public ShelfTrancheStructurePage clickEdit() {
        clickk(btn_Edit, WaitStrategy.CLICKABLE, "Edit icon");
        return this;
    }

    public NewShelfTrancheStructurePage clickContinue() {
        jsClick(continuee, "Continue button");
        return new NewShelfTrancheStructurePage();
    }

    public ShelfTrancheStructurePage clickHamburger() {
        Uninterruptibles.sleepUninterruptibly(3, TimeUnit.SECONDS);
        moveToElement(DriverManager.getDriver().findElement(hamburgerMenu), "HamburgerMenu");
        return this;
    }

    public ShelfTrancheStructurePage create_SDD_with_ZeroCoupon() {
    ...
    public ShelfTrancheStructurePage clickArchivedTrancheTab() {
        clickk(archivedTrancheTab, WaitStrategy.CLICKABLE, "Archived Tranche Tab");
        return this;
    }
    public ShelfTrancheStructurePage searchExtId(String ID) {
    ...
    public ShelfTrancheStructurePage clickAttachedDocTab() {
        clickk(drawdownAttachedDocumentsTab, WaitStrategy.CLICKABLE, "Attached Documents tab");
        return this;

    }

    public ShelfTrancheStructurePage clickUploadDocuments() {
        jsClick(Btn_uploadDocs, "Upload Documents button");
        return this;
    }

    public ShelfTrancheStructurePage uploadAttachedDoc() throws AWTException {
    ...
    public ShelfTrancheStructurePage clickClose() {
    ...
    public ShelfTrancheStructurePage clickCovenantsTab() {
        clickk(covenantsTab, WaitStrategy.CLICKABLE, "Covenants Tab");
        return this;
    }

    public ShelfTrancheStructurePage clickAddCovenants() {
        clickk(btn_addCovenants, WaitStrategy.CLICKABLE, "Add Covenants Button");
        Uninterruptibles.sleepUninterruptibly(3, TimeUnit.SECONDS);
        return this;
    }

    public ShelfTrancheStructurePage covenantTemplate(String tem) {
    ...
    public ShelfTrancheStructurePage enterAccountablePerson(String text) {
        sendText(accountablePerson, text, WaitStrategy.PRESENCE, "Accountable Person");
        return this;
    }

    public ShelfTrancheStructurePage enterThirdParty(String text) {
        sendText(thirdParty, text, WaitStrategy.PRESENCE, "ThirdParty");
        return this;
    }

    public ShelfTrancheStructurePage enterTargetValue(String text) {
    ...
    public ShelfTrancheStructurePage selectMappingConditions(String text) {
    ...
    public ShelfTrancheStructurePage selectCovenantsEntity(String text) {
    ...
    public ShelfTrancheStructurePage selectRatioName(String text) {
    ...
    public ShelfTrancheStructurePage enterThresholdPercentage(String text) {
    ...
    public ShelfTrancheStructurePage enterCloseNotes(String value) {
    ...
    public ShelfTrancheBlotter clickDeleteIcon() {
        for (int i = 0; i < 10; i++) {
            try {
    ...
    public ShelfTrancheStructurePage create_SDD_without_ZeroCoupon() {
        LiabilityDashboardsPage ld = new LiabilityDashboardsPage();
        ld.clickLiability().clickShelfTrancheStructure().moveToHamburgerMenu().clickAdd()
                .enterExternalID(6).enterLedgerID(6)
                .selectIssuer("ENTITY_FOR_AUTOMATION_ONLY").selectCurrency("INR")
