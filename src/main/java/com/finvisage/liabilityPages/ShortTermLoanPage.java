...
public class ShortTermLoanPage extends BasePageLiability{
    ...
    private final By stlLabel = By.xpath("(//a[text()='Short Term Loan'])[1]");
    private final By stlExternal_ID = By.xpath("//span[text()='External ID:']//parent::div//following-sibling::div/span");
    ...
    public ShortTermLoanPage clickOptions() {
        clickk(options, WaitStrategy.CLICKABLE, "Drawdown option");
        return this;
    }

    public NewSTLDrawdownPage clickAddDrawdown() {
    ...
    public STLBlotterPage clickDeleteIcon() {
        for (int i = 0; i < 10; i++) {
            try {
    ...
    public ShortTermLoanPage clickClose() {
        clickk(btn_Close, WaitStrategy.CLICKABLE, "Close icon");
        return this;
    }

    public ShortTermLoanPage clickEdit() {
        clickk(btn_Edit, WaitStrategy.CLICKABLE, "Edit icon");
        return this;
    }

    public ShortTermLoanPage clickContinue() {
        jsClick(continuee, "Continue button");
        return new ShortTermLoanPage();
    }

    public ShortTermLoanPage enterCloseNotes(String value) {
        sendText(close_note, value, WaitStrategy.VISIBLE, "Close Notes");
        return this;
    }


    public ShortTermLoanPage clickSubmitToClose() {
        clickk(btn_Close_submit, WaitStrategy.CLICKABLE, "submit button");
        return this;
    }

    public STLBlotterPage getLoanSTLBlotter() {
        moveToElement(DriverManager.getDriver().findElement(stlLabel), "Label-STL");
        jsClick(stlLabel, "Label-STL");
        return new STLBlotterPage();
    }

    public String getLfExrnlID() {
        return getText(stlExternal_ID, WaitStrategy.VISIBLE, "External ID");
    }

    public ShortTermLoanPage clickLienDetails() {
        clickk(lienDetails, WaitStrategy.CLICKABLE, "Lien Details Tab");
        return this;
    }

    public ShortTermLoanPage clickAddToLienFD() {
    ...
    public ShortTermLoanPage clickUploadDocuments() {
    ...
    public ShortTermLoanPage clickCovenantsTab(){
        clickk(covenantsTab,WaitStrategy.CLICKABLE,"Covenants Tab");
        return this;
    }
    public ShortTermLoanPage clickAddCovenants(){
        clickk(btn_addCovenants,WaitStrategy.CLICKABLE,"Add Covenants Button");
        Uninterruptibles.sleepUninterruptibly(3,TimeUnit.SECONDS);
        return this;
    }
    public ShortTermLoanPage covenantTemplate(String tem) {
    ...
    public ShortTermLoanPage enterAccountablePerson(String text){
        sendText(accountablePerson,text,WaitStrategy.PRESENCE,"Accountable Person");
        return this;
    }
    public ShortTermLoanPage enterThirdParty(String text){
        sendText(thirdParty,text,WaitStrategy.PRESENCE,"ThirdParty");
        return this;
    }
    public ShortTermLoanPage enterTargetValue(String text){
    ...
    public ShortTermLoanPage selectMappingConditions(String text){
    ...
    public ShortTermLoanPage selectCovenantsEntity(String text){
    ...
    public ShortTermLoanPage selectRatioName(String text){
    ...
    public ShortTermLoanPage enterThresholdPercentage(String text){
    ...
    public ShortTermLoanPage create_new_STL_liability() {
        LiabilityDashboardsPage ldp = new LiabilityDashboardsPage();
        ldp.clickLiability().clickSTL().moveToHamburgerMenu().clickAdd()
                .enterExternalID(10).enterLedgerID(7)
                .selectEntity("ENTITY_FOR_AUTOMATION_ONLY")
                .selectCounterparty("AUTOMATION_PARTY")
                .selectArranger("ARRANGER_01")
                .enterStartDate("19/01/2024")
                .enterEndDate("18/01/2025")
                .enterPrincipalAmount(sanctionedAmount[(int) (Math.random() * sanctionedAmount.length)])
