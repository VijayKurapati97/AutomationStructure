...
public class StandaloneStructurePage extends BasePageLiability {
    ...
    public StandaloneStructurePage clickEdit() {
        clickk(btn_Edit, WaitStrategy.CLICKABLE, "Edit icon");
        return this;
    }

    public NewStandaloneStructurePage clickContinue() {
    ...
    public StandaloneStructurePage clickUploadDocuments() {
    ...
    public StandaloneStructurePage clickClose() {
    ...
    public StandaloneStructurePage clickCreditRatingTab() {
        clickk(creditRatingTab, WaitStrategy.CLICKABLE, "Credit Rating Tab");
        return this;
    }

    public StandaloneStructurePage clickAddCreditRating() {
        clickk(btn_addCreditRating, WaitStrategy.CLICKABLE, "Add Credit Rating");
        return this;
    }

    public StandaloneStructurePage selectRatingAgency(String text) {
    ...
    public StandaloneStructurePage selectRatingSymbol(String text) {
    ...
    public StandaloneStructurePage selectOutlook(String text) {
    ...
    public StandaloneStructurePage clickFeetab() {
        jsClick(feeTab, WaitStrategy.CLICKABLE, " Fee Tab");
        return this;
    }

    public StandaloneStructurePage clickAddFee() {
        jsClick(btn_AddFee, WaitStrategy.CLICKABLE, " Add Fee button");
        return this;
    }

    public StandaloneStructurePage feeType(String feeType) {
        Uninterruptibles.sleepUninterruptibly(3, TimeUnit.SECONDS);
    ...
    public StandaloneStructurePage amountType(String amountType) {
    ...
    public StandaloneStructurePage enterFeeValue(String feevalue) {
    ...
    public StandaloneStructurePage enterRemarks(String remarks) {
    ...
    public StandaloneStructurePage cancelFee() {
        try {
    ...
    public StandaloneStructurePage clickCovenantsTab() {
        clickk(covenantsTab, WaitStrategy.CLICKABLE, "Covenants Tab");
        return this;
    }

    public StandaloneStructurePage clickAddCovenants() {
        clickk(btn_addCovenants, WaitStrategy.CLICKABLE, "Add Covenants Button");
        Uninterruptibles.sleepUninterruptibly(3, TimeUnit.SECONDS);
        return this;
    }

    public StandaloneStructurePage covenantTemplate(String tem) {
    ...
    public StandaloneStructurePage enterAccountablePerson(String text) {
        sendText(accountablePerson, text, WaitStrategy.PRESENCE, "Accountable Person");
        return this;
    }

    public StandaloneStructurePage enterThirdParty(String text) {
        sendText(thirdParty, text, WaitStrategy.PRESENCE, "ThirdParty");
        return this;
    }

    public StandaloneStructurePage enterTargetValue(String text) {
    ...
    public StandaloneStructurePage selectMappingConditions(String text) {
    ...
    public StandaloneStructurePage selectCovenantsEntity(String text) {
    ...
    public StandaloneStructurePage selectRatioName(String text) {
    ...
    public StandaloneStructurePage enterThresholdPercentage(String text) {
    ...
    public StandaloneStructurePage enterCloseNotes(String value) {
    ...
    public StandaloneBlotterPage clickDeleteIcon() {
        for (int i = 0; i < 10; i++) {
            try {
    ...
    public StandaloneStructurePage clickInvestorsTab() {
        clickk(investorsTab, WaitStrategy.CLICKABLE, "Investors Tab");
        return this;
    }
    public StandaloneStructurePage clickBenposOptions(){
        clickk(benposScheduleOptions,WaitStrategy.CLICKABLE,"Benpos Options");
        return this;
    }
    public StandaloneStructurePage selectAddEquatedbenposSchedule(){
        clickk(benposEquatedSchedule,WaitStrategy.CLICKABLE," Equated Schedule");
        return this;
    }
    public StandaloneStructurePage enterRTAAlertOffset(String value){
    ...
    public StandaloneStructurePage enterRTAIntimationOffset(String value){
    ...
    public StandaloneStructurePage enterPaymentAlertOffset(String value){
    ...
    public StandaloneStructurePage clickPrincipalScheduleOptions() {
        scrollIntoView(principalScheduleOptions);
        clickk(principalScheduleOptions, WaitStrategy.CLICKABLE, "Principal Schedule Options");
        return this;
    }

    public StandaloneStructurePage selectAddEquatedPrincipalSchedule() {
        clickk(equatedSchedule1, WaitStrategy.CLICKABLE, "Equated schedule");
        return this;

    }

    public StandaloneStructurePage selectPrincipalPayout(String value) {
    ...
    public StandaloneStructurePage selectPrincipalPaymentConvention(String value) {
    ...
    public StandaloneStructurePage selectPrincipalRounding(String mode) {
    ...
    public StandaloneStructurePage clickOnPreview() {
        scrollIntoView(btn_preview);
        jsClick(btn_preview, WaitStrategy.CLICKABLE, "Preview");
        return this;
    }

    public StandaloneStructurePage clickOnGenerateSchedule() {
