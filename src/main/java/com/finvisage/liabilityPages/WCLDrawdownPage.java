...
public class WCLDrawdownPage extends BasePageLiability {
    ...
    public WCLDrawdownPage enterPrepaymentValueDate(String text) {
    ...
    public WCLDrawdownPage enterPrepaymentAmount(String text) {
    ...
    public WCLDrawdownPage make_prepayments_Payments() {
    ...
    public WCLDrawdownPage clickSubmit() {
    ...
    public WCLDrawdownPage clickUploadDocuments() {
    ...
    public WCLDrawdownPage clickClose() {
    ...
    public WCLDrawdownPage selectCallExerciseDay(String day) {
    ...
    public WCLDrawdownPage clickCallSchedulePreview() {
        clickk(btn_preview, WaitStrategy.CLICKABLE, "preview button");
        return this;
    }

    public WCLDrawdownPage enterCallDate(String text) {
    ...
    public WCLDrawdownPage clickFeetab() {
        jsClick(feeTab, WaitStrategy.CLICKABLE, " Fee Tab");
        return this;
    }

    public WCLDrawdownPage clickAddFee() {
        jsClick(btn_AddFee, WaitStrategy.CLICKABLE, " Add Fee button");
        return this;
    }

    public WCLDrawdownPage feeType(String feeType) {
        Uninterruptibles.sleepUninterruptibly(3, TimeUnit.SECONDS);
    ...
    public WCLDrawdownPage amountType(String amountType) {
    ...
    public WCLDrawdownPage enterFeeValue(String feevalue) {
    ...
    public WCLDrawdownPage enterRemarks(String remarks) {
    ...
    public WCLDrawdownPage cancelFee() {
        try {
    ...
    public WCLDrawdownPage clickCovenantsTab() {
        clickk(covenantsTab, WaitStrategy.CLICKABLE, "Covenants Tab");
        return this;
    }

    public WCLDrawdownPage clickAddCovenants() {
        clickk(btn_addCovenants, WaitStrategy.CLICKABLE, "Add Covenants Button");
        Uninterruptibles.sleepUninterruptibly(3, TimeUnit.SECONDS);
        return this;
    }

    public WCLDrawdownPage covenantTemplate(String tem) {
    ...
    public WCLDrawdownPage enterAccountablePerson(String text) {
        sendText(accountablePerson, text, WaitStrategy.PRESENCE, "Accountable Person");
        return this;
    }

    public WCLDrawdownPage enterThirdParty(String text) {
        sendText(thirdParty, text, WaitStrategy.PRESENCE, "ThirdParty");
        return this;
    }

    public WCLDrawdownPage enterTargetValue(String text) {
    ...
    public WCLDrawdownPage selectMappingConditions(String text) {
    ...
    public WCLDrawdownPage selectCovenantsEntity(String text) {
    ...
    public WCLDrawdownPage selectRatioName(String text) {
    ...
    public WCLDrawdownPage enterThresholdPercentage(String text) {
    ...
    public WCLDrawdownPage clickOnCreate() {
        try{
            doubleClick(btn_Submit);
            Alert al= DriverManager.getDriver().switchTo().alert();
            al.accept();
    ...
    public WCLDrawdownPage clickLienDetails() {
        clickk(lienDetails, WaitStrategy.CLICKABLE, "Lien Details Tab");
        return this;
    }

    public WCLDrawdownPage clickAddToLienFD() {
    ...
    public WCLPage clickDeleteDrawdown() {
        for (int i = 0; i < 10; i++) {
            try {
