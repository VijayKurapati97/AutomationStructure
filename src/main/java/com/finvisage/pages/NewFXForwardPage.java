...
public class NewFXForwardPage extends BasePage{
    private  static Logger logger = LogManager.getLogger(NewFXForwardPage.class);
    ...
    private String underlyingValues="//div[text()='%replace%']";
    private final By direction = By.xpath("//div[@class='selectize-input items not-full has-options']");
    private String directionValue="//div[text()='%replace%']";
    private final By notionalCcyDropdown=By.xpath("//div[@class='selectize-control select optional selectize notional_ccy_asset_caller single']");
    private String notionalCcyValue="//div[text()='%replace%']";
...
private final By payoffGraph=By.xpath("//div[@id='pay-off-graph-block']");
    ...
    public NewFXForwardPage marketDataAvilability(){
