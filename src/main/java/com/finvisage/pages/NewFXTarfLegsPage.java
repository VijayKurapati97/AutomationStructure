...
public class NewFXTarfLegsPage extends BasePage{
    ...
    public NewFXTarfLegsPage clickUnderlying(){
        clickk(underlying, WaitStrategy.CLICKABLE,"Underlying");
        return this;
    }
    public NewFXTarfLegsPage selectUnderlying(String text){
    ...
    public NewFXTarfLegsPage selectDirectionValue(String value){
    ...
    public NewFXTarfLegsPage clickNotionalCcy(){
        clickk(notionalCcyDropdown,WaitStrategy.CLICKABLE,"Notional Ccy Dropdown");
        return this;
    }
    public NewFXTarfLegsPage selectNotionalCcyValue(String value){
    ...
    public NewFXTarfLegsPage enterKnockout(String Knockout){
    ...
    public NewFXTarfLegsPage clickTarfGenerateLegs(){
        jsClick(generateLegs1,WaitStrategy.CLICKABLE,"Generate legs");
        Uninterruptibles.sleepUninterruptibly(2,TimeUnit.SECONDS);
        return this;
    }
    public NewFXTarfLegsPage enterNotional(String value){
    ...
    public NewFXTarfLegsPage enterStrikes(String value){
        int num=Integer.parseInt(value);
        Actions act= new Actions(DriverManager.getDriver());
        for(int i=1;i<=num;i++){
            String notional="//body[1]/main[1]/section[1]/div[3]/div[1]/section[1]/form[1]/div[2]/div[1]" +
    ...
    public NewFXTarfLegsPage clickPriceButton(){
        clickk(btnPrice,WaitStrategy.CLICKABLE,"Price button");
        return this;
    }
    public NewFXTarfLegsPage priceSectionDisplayed(){
    ...
    public NewFXTarfLegsPage enterNumberOfLegs(String number){
        sendText(numLegs,number,WaitStrategy.PRESENCE,"Number of legs");
        return this;
    }
    public NewFXTarfLegsPage enterDiscountingRate(String Rate){
    ...
    public NewFXTarfLegsPage clickGenerateLegs(){
        jsClick(generateLegs,WaitStrategy.CLICKABLE,"Generate legs");
        Uninterruptibles.sleepUninterruptibly(3,TimeUnit.SECONDS);
        return this;
    }
    public NewFXTarfLegsPage clickCalculate(){
        JavascriptExecutor js = (JavascriptExecutor)DriverManager.getDriver();
    ...
    public NewFXTarfLegsPage getDeffermentRate(){
