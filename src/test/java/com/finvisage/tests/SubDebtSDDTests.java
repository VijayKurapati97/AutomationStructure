...
public class SubDebtSDDTests extends BaseTest{
    ...
    private SubDebtSDDTests() {
    }

    @Test(groups = {"Smoke"})
    public void SubDebtSDD_Create_SDD_ZeroCoupon(Map<String, String> data) {
        ...
        Assertions.assertThat(DriverManager.getDriver().getTitle())
                .contains("Shelf Tranche Structures - SUBDNCD").doesNotContain("Shelf Tranche Structure - New");

    }

    @Test(groups = {"Smoke"})
    public void SubDebtSDD_Create_SDD_Tranche_ZeroCoupon(Map<String, String> data) {
        ExtentManager.getExtentTest().assignAuthor("Vijay").assignCategory("Smoke");
        LiabilityLogInPage lp = new LiabilityLogInPage();
        String[] user = lp.LogIn(FrameworkConstants.getUser());
        userThreadLocal.set(user);
        SubDebtSDDPage sf=new SubDebtSDDPage();
    ...
    @Test(groups = {"Smoke"})
    public void SubDebtSDD_Update_SDD(Map<String, String> data) {
        ExtentManager.getExtentTest().assignAuthor("Vijay").assignCategory("Smoke");
        LiabilityLogInPage lp = new LiabilityLogInPage();
        String[] user = lp.LogIn(FrameworkConstants.getUser());
        userThreadLocal.set(user);
        ...
        Assertions.assertThat(DriverManager.getDriver().getTitle()).isEqualTo("Sub Debt NCD Shelf Tranche - Edit");
        NewSubDebtSDDPage st=new NewSubDebtSDDPage();
        st.enterDescription("SDD Updated").clickCreate();
        Uninterruptibles.sleepUninterruptibly(3, TimeUnit.SECONDS);
        Assertions.assertThat(DriverManager.getDriver().getTitle()).contains("Shelf Tranche Structures - SUBDNCD");
    }

    @Test(groups = {"Smoke"})
    public void SubDebtSDD_Create_SDD_Tranche_Without_ZeroCoupon(Map<String, String> data) {
        ExtentManager.getExtentTest().assignAuthor("Vijay").assignCategory("Smoke");
        LiabilityLogInPage lp = new LiabilityLogInPage();
        String[] user = lp.LogIn(FrameworkConstants.getUser());
        userThreadLocal.set(user);
    ...
    @Test(groups = {"Smoke"})
    public void SubDebtSDD_Create_SDD_Without_ZeroCoupon(Map<String, String> data) {
        ExtentManager.getExtentTest().assignAuthor("Vijay").assignCategory("Smoke");
        LiabilityLogInPage lp = new LiabilityLogInPage();
        String[] user = lp.LogIn(FrameworkConstants.getUser());
        userThreadLocal.set(user);
        ...
        ld.clickLiability().clickSubDebtShelfTrancheStructure().moveToHamburgerMenu().clickAdd()
                ...
                .clickCreate();
        Assertions.assertThat(DriverManager.getDriver().getTitle())
                .contains("Shelf Tranche Structures - SUBDNCD").doesNotContain("Sub Debt NCD Shelf Tranche - New");

    }

    @Test(groups = {"Smoke"})
    public void SubDebtSDD_Tranche_AttachedDocuments(Map<String, String> data) throws AWTException {
        ExtentManager.getExtentTest().assignAuthor("Vijay").assignCategory("Smoke");
        LiabilityLogInPage lp = new LiabilityLogInPage();
        String[] user = lp.LogIn(FrameworkConstants.getUser());
        userThreadLocal.set(user);
        ...
        sf.create_SDD_without_ZeroCoupon();
        SubDebtSDDTranchePage sd=new SubDebtSDDTranchePage();
    ...
    @Test(groups = {"Smoke"})
    public void SubDebtSDD_Tranche_Add_CreditRating(Map<String, String> data)  {
        ExtentManager.getExtentTest().assignAuthor("Vijay").assignCategory("Smoke");
        LiabilityLogInPage lp = new LiabilityLogInPage();
        String[] user = lp.LogIn(FrameworkConstants.getUser());
        userThreadLocal.set(user);
    ...
    @Test(groups = {"Smoke"})
    public void SubDebtSDD_Tranche_Add_and_Cancel_Fee(Map<String, String> data) {
        ExtentManager.getExtentTest().assignAuthor("Vijay").assignCategory("Smoke");
        LiabilityLogInPage lp = new LiabilityLogInPage();
        String[] user = lp.LogIn(FrameworkConstants.getUser());
        userThreadLocal.set(user);
    ...
    @Test(groups = {"Smoke"})
    public void SubDebtSDD_Tranche_Add_Covenants(Map<String, String> data) {
        ExtentManager.getExtentTest().assignAuthor("Vijay").assignCategory("Smoke");
        LiabilityLogInPage lp = new LiabilityLogInPage();
        String[] user = lp.LogIn(FrameworkConstants.getUser());
        userThreadLocal.set(user);
    ...
    @Test(groups = {"Smoke"})
    public void SubDebtSDD_Tranche_Create_Benpos_Schedule(Map<String, String> data) {
        ExtentManager.getExtentTest().assignAuthor("Vijay").assignCategory("Smoke");
        LiabilityLogInPage lp = new LiabilityLogInPage();
        String[] user = lp.LogIn(FrameworkConstants.getUser());
        userThreadLocal.set(user);
    ...
    @Test(groups = {"Smoke"})
    public void SubDebtSDD_CreateTranche_CloseTranche(Map<String, String> data) {
        ExtentManager.getExtentTest().assignAuthor("Vijay").assignCategory("Smoke");
        LiabilityLogInPage lp = new LiabilityLogInPage();
        String[] user = lp.LogIn(FrameworkConstants.getUser());
        userThreadLocal.set(user);
        ...
        sd.clickHamburger().clickClose().enterCloseNotes(data.get("Notes"))
                .clickSubmitToClose();
        LiabilityDashboardsPage ld = new LiabilityDashboardsPage();
        ld.clickSubDebtShelfTrancheStructure().selectFirstSDD(LoanExternalID);
        Uninterruptibles.sleepUninterruptibly(4, TimeUnit.SECONDS);
        SubDebtSDDPage st=new SubDebtSDDPage();
    ...
    @Test(groups = {"Smoke"})
    public void SubDebtSDD_Create_Tranche_Delete(Map<String, String> data) {
        ExtentManager.getExtentTest().assignAuthor("Vijay").assignCategory("Smoke");
        LiabilityLogInPage lp = new LiabilityLogInPage();
        String[] user = lp.LogIn(FrameworkConstants.getUser());
        userThreadLocal.set(user);
    ...
    @Test(groups = {"Smoke"})
    public void SubDebtSDD_AttachedDocuments(Map<String, String> data) throws AWTException {
        ExtentManager.getExtentTest().assignAuthor("Vijay").assignCategory("Smoke");
        LiabilityLogInPage lp = new LiabilityLogInPage();
        String[] user = lp.LogIn(FrameworkConstants.getUser());
        userThreadLocal.set(user);
        SubDebtSDDPage ss=new SubDebtSDDPage();
    ...
    @Test(groups = {"Smoke"})
    public void SubDebtSDD_Add_Covenants(Map<String, String> data) {
        ExtentManager.getExtentTest().assignAuthor("Vijay").assignCategory("Smoke");
        LiabilityLogInPage lp = new LiabilityLogInPage();
        String[] user = lp.LogIn(FrameworkConstants.getUser());
        userThreadLocal.set(user);
    ...
    @Test(groups = {"Smoke"})
    public void SubDebtSDD_Create_Close(Map<String, String> data) {
        ExtentManager.getExtentTest().assignAuthor("Vijay").assignCategory("Smoke");
        LiabilityLogInPage lp = new LiabilityLogInPage();
        String[] user = lp.LogIn(FrameworkConstants.getUser());
        userThreadLocal.set(user);
        ...
        ss.clickHamburger().clickClose().enterCloseNotes(data.get("Notes"))
                .clickSubmitToClose();
        LiabilityDashboardsPage ld = new LiabilityDashboardsPage();
        ld.clickSubDebtShelfTrancheStructure();
        SubDebtSDDBlotter sb=new SubDebtSDDBlotter();
    ...
    @Test(groups = {"Smoke"})
    public void SubDebtSDD_Create_Delete(Map<String, String> data) {
        ExtentManager.getExtentTest().assignAuthor("Vijay").assignCategory("Smoke");
        LiabilityLogInPage lp = new LiabilityLogInPage();
        String[] user = lp.LogIn(FrameworkConstants.getUser());
        userThreadLocal.set(user);
    ...
    @Test(groups = {"Smoke"})
    public void SubDebtSDD_Update_Tranche(Map<String, String> data) {
        ExtentManager.getExtentTest().assignAuthor("Vijay").assignCategory("Smoke");
        LiabilityLogInPage lp = new LiabilityLogInPage();
        String[] user = lp.LogIn(FrameworkConstants.getUser());
        userThreadLocal.set(user);
